...
"""
知识点:python操作mysql,查询(查询单条、查询多条、查询所有),通过占位符查询
"""
...
# 第四步: 把活得数据通过%s进行占位,再通过元组进行赋值(这种方式更加安全,他会先发送sql语句结构在发送参数数据)
count = cursor.execute('select * from account where name = %s;', ('xiaohua',))
